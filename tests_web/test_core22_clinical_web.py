...
def test_clinical_list_routes_support_lifecycle_visibility():
    assert "def medications(" in APP and "include_archived: bool = False" in APP
    assert "def list_encounters(" in APP and "include_archived: bool = False" in APP
    assert "def list_prescriptions(" in APP and "include_archived: bool = False" in APP
    assert "data_repository.list_medications" in APP and "include_archived" in APP
    assert "data_repository.list_encounters" in APP and "include_archived" in APP
    assert "data_repository.list_prescriptions" in APP and "include_archived" in APP
