...
class PublicUserRegistrationRequest(BaseModel):
    model_config = ConfigDict(extra="forbid")
    username: str = Field(min_length=3, max_length=150)
    password: str = Field(min_length=8, max_length=512)
    full_name: str = Field(min_length=1, max_length=200)
...
class ClinicUserAssignmentRequest(BaseModel):
    model_config = ConfigDict(extra="forbid")
    user_id: str = Field(min_length=1, max_length=100)
    clinic_id: str = Field(min_length=1, max_length=100)
    role_scope: str = Field(default="member", min_length=1, max_length=20)

class ClinicPatientAssignmentRequest(BaseModel):
    model_config = ConfigDict(extra="forbid")
